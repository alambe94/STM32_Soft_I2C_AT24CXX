...
uint8_t
AT24CXX_Write_Byte (uint16_t register_address, uint8_t data)
{
...
uint8_t
AT24CXX_Read_Byte (uint16_t register_address, uint8_t* data)
{
...
uint8_t
AT24CXX_Write_Page (uint16_t start_address, uint8_t *buf, uint16_t len)
{
...
uint8_t
AT24CXX_Read_Buffer (uint16_t start_address, uint8_t *buf, uint16_t len)
{
...
uint8_t
AT24CXX_Write_Buffer (uint16_t start_address, uint8_t *buf, uint16_t len)
{
